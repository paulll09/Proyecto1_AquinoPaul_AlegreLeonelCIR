...
$routes->get('consultas/marcar/(:num)', 'ConsultasController::marcarComoLeida/$1');
$routes->get('consultas/eliminar/(:num)', 'ConsultasController::eliminar/$1');
$routes->get('perfil/editar', 'UsuariosController::editar_perfil');
$routes->get('usuario/editar_perfil', 'UsuariosController::editar_perfil');
$routes->post('usuario/actualizar_perfil', 'UsuariosController::actualizar_perfil');
$routes->get('mis-compras', 'VentasController::mis_compras');
