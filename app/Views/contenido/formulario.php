...
<div class="row">
  ...
  <div class="col-lg-8">
    <div class="contact-form p-4 bg-white rounded-3 shadow-sm">
      ...
      <?= form_open('contacto/enviar') ?>
      <?= csrf_field() ?> <!-- Campo CSRF si está habilitado en tu app -->
      ...
      <?php if (session()->getFlashdata('mensaje_contacto')): ?>
        <script>
          Swal.fire({
            icon: 'success',
            title: '¡Mensaje enviado!',
            text: '<?= session()->getFlashdata('mensaje_contacto'); ?>',
