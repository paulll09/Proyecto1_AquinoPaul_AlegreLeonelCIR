        ...
        <tbody>
            <?php foreach ($productos as $row) { ?>
                <tr>
                    ...
                    <td><img src="<?php echo base_url('public/assets/uploads/' . $row['imagen']) ?>" alt="Imagen del producto" class="img-thumbnail" style="width: 100px;"></td>
                    <td><?php echo ($row['categoria_descripcion']) ?></td>
                    <td>
                        <a class="btn btn-success" href="<?php echo base_url('editar_producto/' . $row['id_producto']); ?>">Editar Producto</a>
                    </td>
                    <?php
